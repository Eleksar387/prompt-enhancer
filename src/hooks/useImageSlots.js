...
// list, its voice-timbre audio, and the "seed" handoff that loads a picked history
// thumbnail into a panel.
//
...
// setLastImg(null); setRefImages([]); setRefAudio(null)` plus the seed reset — was
...
export function useImageSlots() {
  ...
  const [refAudio, setRefAudio] = useState(null)   // H3 voice-timbre reference
  ...
  return {
    ...
    refImages, setRefImages, refAudio, setRefAudio,
